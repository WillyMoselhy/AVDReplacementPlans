...
| FixSessionHostTags                           | No                                        | If true, will apply tags for Include In Auto Repalce and Deployment Timestamp to existing session hosts. This will not enable automatic deletion of existing session hosts.                                             | bool   | True.                                        |
...
| TagPendingDrainTimestamp                     | No                                        | Tag name used tp indicate drain timestamp of session host pending deletion.                                                                                                                                             | string | AutoReplacePendingDrainTimestamp.            |
| TagScalingPlanExclusionTag                   | No                                        | Tag name used to exclude session host from Scaling Plan activities.                                                                                                                                                     | string | (None)                                       |
