...
$bicepParams = @{
    ...
    SessionHostTemplateUri    = "https://raw.githubusercontent.com/WillyMoselhy/AVDReplacementPlans/AAD-Join/SampleSessionHostTemplate/sessionhost.json"
    FunctionAppZipUrl         = 'https://github.com/WillyMoselhy/AVDReplacementPlans/releases/download/v0.1.1/FunctionApp.zip'
